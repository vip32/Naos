namespace Naos.Core.App.Commands
{
    ...
    public class CommandEntityInMemoryRepository : InMemoryRepository<CommandEntity, string>, ICommandRequestRepository
    {
        ...
        public CommandEntityInMemoryRepository(IMediator mediator, IEnumerable<CommandEntity> entities = null)
            : base(mediator, entities, (e) => Guid.NewGuid().ToString())
        {
        }
    }
}
