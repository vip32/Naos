namespace Naos.Core.Authentication.App.Web
{
    ...
    public class ApiKeyAuthenticationHandler : BaseAuthenticationHandler<AuthenticationHandlerOptions, AuthenticationHandlerEvents>
    {
        ...
        protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            try
            {
                this.Logger.LogInformation($"{LogEventIdentifiers.Authentication} apikey handle");
                ...
                if (this.Request.Host.Host.SafeEquals("localhost") && this.Options.IgnoreLocal)
                {
                    ...
                    this.Logger.LogInformation($"{LogEventIdentifiers.Authentication} apikey authenticated (name={identity.Name})");
...
#pragma warning restore SA1008 // Opening parenthesis must be spaced correctly
                ...
                this.Logger.LogWarning($"{LogEventIdentifiers.Authentication} apikey not authenticated");
