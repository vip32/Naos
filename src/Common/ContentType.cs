namespace Naos.Core.Common
{
    ...
    public enum ContentType
    {
        ...
        [ContentTypeMetadata(Value = "application/x-www-form-urlencoded", IsBinary = false)]
        FORM,

        [ContentTypeMetadata(Value = "multipart/form-data", IsBinary = false)]
        MFORM,
...
#pragma warning restore CA1720 // Identifier contains type name
        ...
        [ContentTypeMetadata(Value = "application/pdf", IsBinary = true, FileExtension = "pdf")]
        PDF,
        ...
        [ContentTypeMetadata(Value = "text/plain", IsText = true, FileExtension = "txt")]
        TEXT,
