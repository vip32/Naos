namespace Naos.Core.Messaging
{
        ...
        where T : class, IEntity
    {
        ...
        public virtual Task Handle(EntityMessage<T> message)
        {
            ...
            {
                this.logger.LogInformation("{LogKey} handle (name={MessageName}, id={MessageId}, origin={MessageOrigin}) " + message.Entity.GetType().Name, LogEventKeys.Messaging, message.GetType().PrettyName(), message.Id, message.Origin);
