namespace Naos.Core.Messaging
{
    ...
    public class TestMessageHandler : IMessageHandler<TestMessage>
    {
        ...
        public virtual Task Handle(TestMessage message)
        {
            ...
            {
                this.logger.LogInformation($"{LogEventIdentifiers.Messaging} handle (name={{MessageName}}, id={{MessageId}}, origin={{MessageOrigin}}) " + message.Data, message.GetType().PrettyName(), message.Id, message.Origin);
