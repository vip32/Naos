    ...
    public static class LoggingOptionsExtensions
    {
        public static LoggingOptions AddAzureDiagnosticsLogStream(this LoggingOptions options)
        {
            ...
            if(configuration?.Enabled == true)
            {
                ...
                options.Context.Messages.Add($"{LogEventKeys.Startup} naos services builder: logging azure diagnosticslogstream sink added (path={path})");
            }
        ...
        public static LoggingOptions AddAzureApplicationInsights(this LoggingOptions options)
        {
                ...
                && configuration?.ApplicationKey.IsNullOrEmpty() == false)
            {
                ...
                options.Context.Messages.Add($"{LogEventKeys.Startup} naos services builder: logging azure applicationinsightssink added (application={configuration.ApplicationKey})");
            }
        ...
        public static LoggingOptions UseAzureBlobStorage(this LoggingOptions options)
        {
                ...
                && configuration?.ConnectionString.IsNullOrEmpty() == false)
            {
                ...
                options.Context.Messages.Add($"{LogEventKeys.Startup} naos services builder: logging azure blobstorage added (container={configuration.ContainerName}, path={path})");
            }
