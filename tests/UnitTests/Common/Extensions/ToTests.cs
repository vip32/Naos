namespace Naos.Core.UnitTests.Common
{
    ...
    public class ToTests
    {
        ...
        public void To_Tests()
        {
            ...
            "ABC".To<int>(defaultValue: 42).ShouldBeOfType<int>().ShouldBe(42);
            ...
            "ABC".To<bool>(defaultValue: true).ShouldBeOfType<bool>().ShouldBe(true);
            ...
            Assert.Throws<FormatException>(() => "test".To<bool>(true, defaultValue: false));
