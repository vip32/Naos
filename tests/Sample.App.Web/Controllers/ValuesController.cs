namespace Naos.Sample.App.Web.Controllers
{
    ...
    public class ValuesController : ControllerBase
    {
        ...
        public ValuesController(ILogger<ValuesController> logger, ICountryRepository repository, ICorrelationContextAccessor correlationContext)
        {
        ...
        {
            this.logger.LogInformation($"hello from values controller >> {this.correlationContext.CorrelationContext?.CorrelationId}");
